\section*{Grundlagen}
Aufbau: \fbox{Applikation} -> \fbox{DBMS(Datenbank-Management-System)} -> \fbox{Datenbanken}
...
3Schichten-Modell: \\
\fbox{Externe Ebene(Views)} \\\fbox{Logische Ebene(Schema)} \\\fbox{Interne Ebene (Indizes)}\\
