...
Wenn  das Blatt voll ist: (ggf. rekursiv)

\halfpage{
\begin{enumerate}
\item  Suche das mittlere Element $M_{itte}$, die elemente rechts davon werden neues Blatt;
\item  füge $M_{itte}$ in den Vaterknoten ein, der rechte Verweis zeigt auf das neue Blatt; 
