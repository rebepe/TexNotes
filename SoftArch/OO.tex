...
\submeth{Subtyping} Vererbung von ähnlichem Verhalten (Signaturen) => Generalisierung/Spezialisierung und Realisierung

\submeth{Subclassing} Vererbung von Implementierungen => nur Generalisierung/Spezialisierung
